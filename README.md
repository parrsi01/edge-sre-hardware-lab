...
[Read the complete training guide](TRAINING_GUIDE.md) · [See the skills evidence map](SKILLS_MATRIX.md) · [Open the portfolio site](https://parrsi01.github.io/edge-sre-hardware-lab/) · [Download the illustrated PDF guide](docs/assets/SRE_BEGINNER_GUIDE_IP4IT_GENEVA.pdf)
